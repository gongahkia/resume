...
\begin{skillsSection}{Skills}
    ...
    \skillItem[
        category={Frontend},
        skills={React, React Native, Next.js, Vue.js, Svelte, Flutter}
    ] \\
    \skillItem[
        category={Backend},
        skills={Python, SQL, Go, JavaScript, TypeScript, Node.js, PHP, Rust, Dart}
    ] \\
    \skillItem[
        category={Cloud},
        skills={GCP, Supabase, Firebase, MongoDB, ChromaDB, Pinecone, AWS, Heroku, Docker, Kubernetes, CI/CD}
    ] \\
    \skillItem[
        category={Others},
...
\begin{projectSection}{Projects}
    ...
    \projectItem[
        name={Modo App},
        summary={Social Media Web App for subcultures and niche communities.},
    ...
    \projectItem[
        name={Uzu},
        summary={Browser Extenstion providing structured case summaries via Gemini 2.5 Flash.},
