...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computing and Law;  GPA: 3.6/4.0}{Aug. 2023 -- Aug. 2026}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \resumeSubItem{Languages}
      {Python, JavaScript, Go, Rust, Lua, PHP, SQL, Dart, Haskell, OCaml}
 ...
 \resumeSubHeadingListStart
   ...
   \resumeSubItem{Domain-specific}
      {Singapore Contract law, Singapore Criminal law, Singapore Tort law}
 \resumeSubHeadingListEnd
