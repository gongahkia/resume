...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Ooe}
        {Small markup language that transpiles to HTML.}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \resumeSubItem{Languages}
      {Python, Go, JavaScript, PHP, SQL, Dart, Haskell, Rust, OCaml, C++, Lua}
   \resumeSubItem{Technologies}
      {Svelte, React, Flutter, Laravel}
 \resumeSubHeadingListEnd
