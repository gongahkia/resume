...
\begin{skillsSection}{Skills}
    ...
    \skillItem[
        category={Backend},
        skills={Python, SQL, Go, JavaScript, TypeScript, Node.js, PHP, Rust, Dart, Directus, Hookdeck}
    ] \\
    \skillItem[
        category={Cloud},
        skills={GCP, Supabase, MongoDB, ChromaDB, Pinecone, AWS, Heroku, Docker, Kubernetes, CI/CD}
    ] \\
    \skillItem[
        category={Others},
        skills={Linux, TensorFlow, PyTorch, Hugging Face, WebLLM, Vulkan, WebGL, WebGPU, Haskell, Lua}
    ]\\
    \skillItem[
        category={Legal},
