...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \textit{Aspiring Legal Technologist} & \href{https://github.com/gabrielzmong}{github.com/gabrielzmong}\\
\end{tabular*}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Python, ChromaDB}
          {Programmed AI agents for use in legal scholarship in the research paper 'Hercules in Silico'.}
        \resumeItem{Research}
